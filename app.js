...
function multiply(a, b) { //eslint-disable-line
  let ans = a * b;
  let output = [ans, "The product of " + a + " and " + b + " is " + ans + "."];
  return output;
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let sumString =  a + " and " + b + " and " + c + " sum to " + sum2  + ".";
  let multString = "The product of " + a + " and " + b + " and " + c + " is " + mult2 + ".";
  let output = [sum2,mult2,sumString,multString];
  return output;
}
