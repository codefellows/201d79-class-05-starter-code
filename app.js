...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let firstSumIndex = firstSum[0];
  let secondSum = sum(firstSumIndex, testArray[2]);
  let arrayTotal = secondSum[0];

  let secondIndex = sumArr + ' was passed in as an array of numbers, and ' + arrayTotal + ' is their sum.';

  return [arrayTotal, secondIndex];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  let firstProduct = multiply(testArray[0], testArray[1]);
  let firstProductIndex = firstProduct[0];
  let secondProduct = multiply(firstProductIndex, testArray[2]);
  let productTotal = secondProduct[0];

  let words = 'The numbers ' + multArr + ' have a product of ' + productTotal + '.';

  return [productTotal, words];
}
